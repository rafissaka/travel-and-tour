...
import { Calendar, Clock, User, Phone, MessageSquare, Plus, Loader2, CheckCircle, XCircle, AlertCircle, Trash2, Eye, FileText, Plane, BookOpen } from 'lucide-react';
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex gap-2 pt-4 border-t border-border">
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-background border-2 border-border text-foreground rounded-lg font-medium hover:bg-muted transition-all flex items-center justify-center gap-2 text-sm"
                  >
                  ...
                  {booking.status === 'PENDING' && (
                    <button
                      ...
                      className="px-4 py-2 bg-red-500 text-white rounded-lg font-medium hover:bg-red-600 transition-all flex items-center justify-center gap-2 text-sm"
                    >
