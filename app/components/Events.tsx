...
import { Calendar, MapPin, Clock, ArrowRight, CheckCircle, XCircle, Loader2 } from 'lucide-react';
...
export function Events() {
  ...
  const legacyEvents: Event[] = [
    ...
    },
    {
      ...
      imageUrl: 'https://picsum.photos/seed/volta-culture/800/800',
    ...
    },
    {
      ...
      imageUrl: 'https://picsum.photos/seed/education-fair/800/800',
    ...
    },
    {
      ...
      imageUrl: 'https://picsum.photos/seed/beaches-tour/800/800',
    ...
    },
    {
      ...
      imageUrl: 'https://picsum.photos/seed/exchange-program/800/800',
    ...
    },
    {
      ...
      imageUrl: 'https://picsum.photos/seed/elmina-castle/800/800',
    ...
    },
    {
      ...
      imageUrl: 'https://picsum.photos/seed/nzulezu-village/800/800',
    ...
    },
    {
      ...
      imageUrl: 'https://picsum.photos/seed/aburi-gardens/800/800',
    ...
    },
    {
      ...
      imageUrl: 'https://picsum.photos/seed/boti-falls/800/800',
    ...
    },
    {
      ...
      imageUrl: 'https://picsum.photos/seed/kumasi-festival/800/800',
      location: 'Kumasi, Ashanti Region',
      startDate: '2024-07-01',
      duration: '3 Days',
      status: 'ENDED',
      category: 'tour',
      slug: 'kumasi-festival',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center gap-4 mb-12">
          ...
          <button
            ...
            className={`px-6 py-2 rounded-full font-semibold transition-all ${filter === 'UPCOMING'
                ? 'bg-primary text-white'
                : 'bg-card text-card-foreground hover:bg-muted border border-border'
              }`}
          >
          ...
          <button
            ...
            className={`px-6 py-2 rounded-full font-semibold transition-all ${filter === 'ENDED'
                ? 'bg-primary text-white'
                : 'bg-card text-card-foreground hover:bg-muted border border-border'
              }`}
          >
                  ...
                  >
                    ...
                    {event.status === 'UPCOMING' || event.status === 'ONGOING' ? (
                      <a
                        ...
                        className="w-full bg-primary hover:bg-accent text-white font-bold py-2 rounded-lg transition-all duration-300 flex items-center justify-center gap-2 text-sm"
                      >
                        Book Now
                        <ArrowRight size={16} />
                      </a>
                      ...
                      <a
                        href={`/events/${event.slug}`}
                        className="w-full bg-muted hover:bg-border text-card-foreground font-bold py-2 rounded-lg transition-all duration-300 flex items-center justify-center gap-2 text-sm"
                      >
                        View Details
                        <ArrowRight size={16} />
                      </a>
