...
export default function Carousel({
  ...
  // Create transforms for each item at the component level
  const itemTransforms = carouselItems.map((_, index) => {
      ...
      >
        {carouselItems.map((item, index) => (
          ...
          >
            ...
            <div className="p-5">
              <div className="mb-1 font-black text-lg text-card-foreground">{item.title}</div>
